...
class MassProfile:
    ...
    def massEnclosed(self, ptype, radii):
        ...
        #take center of mass of both galaxies as if 1 particle 
        com_pos = [np.average([com.COM_P(0.1)[0].value,com2.COM_P(0.1)[0].value]),\
                   np.average([com.COM_P(0.1)[1].value,com2.COM_P(0.1)[1].value]),\
                   np.average([com.COM_P(0.1)[2].value,com2.COM_P(0.1)[2].value])]
...
def mEncPlot(galaxy1,snap1,galaxy2,plot_name,a):
    ...
    mProf = MassProfile(galaxy1, snap1,galaxy2) # mass profile
    ...
    plt.yscale('log')
    plt.ylim(1e8, 5e11) 
    plt.title(galaxy1+galaxy2+' Mass Profile ')
    plt.legend()
    # save as image
    plt.savefig(plot_name)
    
    plt.figure()
    plt.plot(r_arr,abs(mProf.hernquistMass(r_arr, a, M_halo_tot) - m_tot)/m_tot,label='residual')
    plt.yscale('log')
...
# plot mass profiles
mEncPlot('MW', '0', 'M31', 'MW_M31_0', 35)
#mEncPlot('MW', 455,'M31', 'MW_M31_455_mass.png', 80.)
#mEncPlot('MW', 500,'M31', 'MW_M31_500_mass.png', 70.)
#mEncPlot('MW', 600,'M31', 'MW_M31_600_mass.png', 55.)
#mEncPlot('MW', 700,'M31', 'MW_M31_700_mass.png', 90.)
#mEncPlot('MW', 800,'M31', 'MW_M31_800_mass.png', 90.)

a = MassProfile('MW', 0, 'M31')
